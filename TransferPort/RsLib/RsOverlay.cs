...
namespace RsLib
{
    ...
    public class RsOverlay : RsModule<RsOverlay>
    {
        ...
        private List<CreateModesHandle> createModesHandles = new List<CreateModesHandle>();
        private List<CreateOverlayToggleInfoHandle> createOverlayToggleInfoHandles = new List<CreateOverlayToggleInfoHandle>();
        private List<CreateOverlayLegendInfoHandle> createOverlayLegendInfoHandles = new List<CreateOverlayLegendInfoHandle>();
