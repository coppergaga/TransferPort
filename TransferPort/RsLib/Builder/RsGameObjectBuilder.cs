    ...
    public class RsGameObjectBuilder {
        ...
        static RsGameObjectBuilder() {
            builderManager = new BuilderManager {
                ...
                new BuilderFn<Component>(o => {
                    o.AppendPrefix();
                    o.Append("[")
                        .Append(o.target.GetType().FullName);
                    o.Append("]");
                }),
                new BuilderFn<MonoBehaviour>(o => {
                    o.AppendKeyValue("enabled", o.target.enabled);
                }),
                new BuilderFn<Transform>(o => {
                ...
                new BuilderFn<Image>(o => { o.AppendKeyValue("sprite", o.target.sprite != null ? o.target.sprite.name : null, true); }),
                new BuilderFn<TMP_Text>(o => {
                ...
                new BuilderFn<SetTextStyleSetting>(o => {
                ...
                new BuilderFn<RsHierarchyReferences>(o => {
